...
> **Net zero CO2 industrial-sector emissions are possible but challenging (high confidence).** [Energy efficiency]{.fragment .highlight-current-blue} will continue to be important. [Reduced materials demand, material efficiency, and circular economy solutions]{.fragment .highlight-current-blue} can reduce the need for primary production.
...
[@akenji2021DegreeLifestylesFair]{.slide-cite}
...
![](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*ihYvXucDDCKIDQtmWQtb-Q.png){fig-alt="A stacked area chart. The title reads: The richest 1% are responsible for double the carbon emissions of the poorest 50%. The figure then displays the shares of the richest 1 and 10, 40 and poorest 50%" style="align:center;"}


## 

::: {.callout-warning icon="false" .smaller}
...
![](../assets/climate_stripes.jpg){width="50%" fig-alt="Composite graph of the climate stripes, showing increasing temperature and global climate conferences"}
...
![](https://www.pnas.org/cms/10.1073/pnas.1900577117/asset/599b11fe-266d-4126-a280-528c58083544/assets/graphic/pnas.1900577117fig03.jpeg){#fig-social_tipping style="justify-content:center;"}

[@otto2020SocialTippingDynamics]{.slide-cite}

## Avoid Carbon Tunnel Vision

![](https://www.sei.org/wp-content/uploads/2022/03/carbon-tunnel-vision.png)
